...
public class calculadora extends javax.swing.JFrame {
    ...
    private void btncalcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncalcActionPerformed
        ...
        //.toString transformou a variável anonasc em String
        int nasc = Integer.parseInt(anonasc.getValue().toString());
        int idade = 2020 - nasc;
        //como o lblidade é string, primeiro transforma a variável idade
        //em string e depois setText(define o texto) no label que só aceita string
